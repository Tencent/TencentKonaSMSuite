...
dependencies {
    implementation("com.tencent.kona:kona-crypto:1.0.5")
    implementation("com.tencent.kona:kona-pkix:1.0.5")
    implementation("com.tencent.kona:kona-ssl:1.0.5")
    implementation("com.tencent.kona:kona-provider:1.0.5")
}
```
