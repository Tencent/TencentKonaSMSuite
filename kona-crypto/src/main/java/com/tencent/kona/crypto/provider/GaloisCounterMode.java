...
import static com.tencent.kona.crypto.util.Constants.SM4_BLOCK_SIZE;

/**
 * This class represents ciphers in GaloisCounter (GCM) mode.
 *
 * <p>This mode currently should only be used w/ SM4 cipher.
 * Although no checking is done, caller should only pass SM4
...
abstract class GaloisCounterMode extends CipherSpi {
     ...
     * @param embeddedCipher Cipher object, such as SM4Crypt.
     */
    ...
    // Wrapper function around SM4-GCM interleaved intrinsic that splits
    ...
    /**
     * Intrinsic for Vector SM4 Galois Counter Mode implementation.
     * SM4 and GHASH operations are interleaved in the intrinsic implementation.
     * return - number of processed bytes
     *
     * Requires 768 bytes (48 SM4 blocks) to efficiently use the intrinsic.
