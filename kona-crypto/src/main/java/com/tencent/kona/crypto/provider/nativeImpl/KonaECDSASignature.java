 ...
 * @since   1.7
 */
abstract class KonaECDSASignature extends SignatureSpi {

    private static final Sweeper SWEEPER = Sweeper.instance();

    private NativeECDSASignature ecdsa;
     ...
     */
    KonaECDSASignature(boolean p1363Format) {
        this.mdNID = -1;
     ...
     */
    KonaECDSASignature(String digestName) {
     ...
     */
    KonaECDSASignature(String digestName, boolean p1363Format) {
        mdNID = Constants.getDigestNID(digestName);
        this.p1363Format = p1363Format;
    }

    // Class for Raw ECDSA signatures.
    static class RawECDSA extends KonaECDSASignature {
    ...
    public static final class SHA1 extends KonaECDSASignature {
        public SHA1() {
            super("SHA1");
        }
    }
    ...
    public static final class SHA1inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA224 extends KonaECDSASignature {
        public SHA224() {
            super("SHA-224");
        }
    }
    ...
    public static final class SHA224inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA256 extends KonaECDSASignature {
        public SHA256() {
            super("SHA-256");
        }
    }
    ...
    public static final class SHA256inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA384 extends KonaECDSASignature {
        public SHA384() {
            super("SHA-384");
        }
    }
    ...
    public static final class SHA384inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA512 extends KonaECDSASignature {
        public SHA512() {
            super("SHA-512");
        }
    }
    ...
    public static final class SHA512inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA3_224 extends KonaECDSASignature {
        public SHA3_224() {
            super("SHA3-224");
        }
    }
    ...
    public static final class SHA3_224inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA3_256 extends KonaECDSASignature {
        public SHA3_256() {
            super("SHA3-256");
        }
    }
    ...
    public static final class SHA3_256inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA3_384 extends KonaECDSASignature {
        public SHA3_384() {
            super("SHA3-384");
        }
    }
    ...
    public static final class SHA3_384inP1363Format extends KonaECDSASignature {
    ...
    public static final class SHA3_512 extends KonaECDSASignature {
        public SHA3_512() {
            super("SHA3-512");
        }
    }
    ...
    public static final class SHA3_512inP1363Format extends KonaECDSASignature {
    ...
    private byte[] signDigestImpl(ECPrivateKey priv) throws SignatureException {
        if (ecdsa == null) {
            ...
            ecdsa = new NativeECDSASignature(mdNID, curveNID, s, true);
            SWEEPER.register(this, new SweepNativeRef(ecdsa));
        }

        byte[] message = buffer.toByteArray();
        buffer.reset();
        byte[] sig = ecdsa.sign(message);
    ...
    protected boolean engineVerify(byte[] signature) throws SignatureException {
        if (ecdsa == null) {
            ...
            ecdsa = new NativeECDSASignature(mdNID, curveNID, publicKey, false);
            SWEEPER.register(this, new SweepNativeRef(ecdsa));
        }
        ...
        byte[] message = buffer.toByteArray();
        buffer.reset();
        return ecdsa.verify(message, sig);
    }
