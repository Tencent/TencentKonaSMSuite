 ...
 * @since 1.7
 */
public final class KonaOneShotECKeyPairGenerator extends KeyPairGeneratorSpi {
     ...
     */
    public KonaOneShotECKeyPairGenerator() {
    ...
    public void initialize(int keySize, SecureRandom random) {
        ...
        curveNID = Constants.getNID(encodedParams);
    }
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random)
        ...
        curveNID = ensureCurveIsSupported(encodedParams, ecSpec);
    ...
    private Optional<KeyPair> generateKeyPairImpl(SecureRandom random)
            throws Exception {
        Object[] keyBytes = NativeCrypto.ecOneShotKeyPairGenGenKeyPair(curveNID);
