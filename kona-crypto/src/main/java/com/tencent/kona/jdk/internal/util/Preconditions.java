...
public class Preconditions {
    ...
    public static final BiFunction<String, List<Number>, StringIndexOutOfBoundsException>
            SIOOBE_FORMATTER = outOfBoundsExceptionFormatter(StringIndexOutOfBoundsException::new);

    public static final BiFunction<String, List<Number>, ArrayIndexOutOfBoundsException>
            AIOOBE_FORMATTER = outOfBoundsExceptionFormatter(ArrayIndexOutOfBoundsException::new);

    public static final BiFunction<String,List<Number>, IndexOutOfBoundsException>
            IOOBE_FORMATTER = outOfBoundsExceptionFormatter(IndexOutOfBoundsException::new);
