...
import com.tencent.kona.sun.security.util.math.*;
import com.tencent.kona.sun.security.util.math.intpoly.*;
...
//        fields.put(IntegerPolynomialP256.MODULUS, MontgomeryIntegerPolynomialP256.ONE);
    ...
    final static class Secp256R1GeneratorMontgomeryMultiplier
        ...
        private Secp256R1GeneratorMontgomeryMultiplier(
            ...
            BigInteger[] factors = new BigInteger[]{
                    BigInteger.ONE,
                    Constants.TWO.pow(64),
                    Constants.TWO.pow(128),
                    Constants.TWO.pow(192)
            };
