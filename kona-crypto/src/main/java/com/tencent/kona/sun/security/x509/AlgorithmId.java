...
public class AlgorithmId implements Serializable, DerEncoder {
    ...
    protected void decodeParams() throws IOException {
        ...
        try {
            algParams = CryptoInsts.getAlgorithmParameters(algidName);
    ...
    public void encode(DerOutputStream out) {
        ...
        if (encodedParams == null) {
            ...
            if (algid.equals((Object) RSASSA_PSS_oid) || algid.equals((Object) ed448_oid)
            ...
            bytes.write(encodedParams, 0, encodedParams.length);
        }
...
//            }
    ...
    public static final ObjectIdentifier SHA256withECDSA_oid =
            Oid.of(KnownOIDs.SHA256withECDSA);
    public static final ObjectIdentifier SHA384withECDSA_oid =
            Oid.of(KnownOIDs.SHA384withECDSA);
    public static final ObjectIdentifier SHA512withECDSA_oid =
            Oid.of(KnownOIDs.SHA512withECDSA);
}
