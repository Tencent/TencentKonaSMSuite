...
public class FieldGen {
    ...
    static FieldParams SM2 = new FieldParams(
        "IntegerPolynomialSM2", 26, 10, 2, 256,
        Arrays.asList(
                new Term(224, -1),
                new Term(96, -1),
                new Term(64, 1),
    ...
    static FieldParams OSM2 = new FieldParams(
            "SM2OrderField", 26, 10, 1, 256,
    ...
    static final FieldParams[] ALL_FIELDS = {
            Curve25519, Curve448,
            SM2, P256, P384, P521, OSM2, O256, O384, O521, O25519, O448
    };
