...
package com.tencent.kona.pkix.perf;
...
/**
 * The JMH-based performance test for keystore operations.
 */
...
public class KeyStorePerfTest {
    ...
    public static class PKCS12KeyStoreHolderKona {

        KeyStore keyStore;

        @Setup(Level.Trial)
        public void setup() throws Exception {
            keyStore = createKeyStore("PKCS12", "KonaPKIX");
        }
    }

    @State(Scope.Benchmark)
    public static class JKSKeyStoreHolderKona {

        KeyStore keyStore;

        @Setup(Level.Trial)
        public void setup() throws Exception {
            keyStore = createKeyStore("JKS", "KonaPKIX");
        }
    }

    @State(Scope.Benchmark)
    public static class PKCS12KeyStoreHolderJDK {

        KeyStore keyStore;

        @Setup(Level.Trial)
        public void setup() throws Exception {
            keyStore = createKeyStore("PKCS12");
        }
    }

    @State(Scope.Benchmark)
    public static class JKSKeyStoreHolderJDK {

        KeyStore keyStore;

        @Setup(Level.Trial)
        public void setup() throws Exception {
            keyStore = createKeyStore("JKS");
        }
    }

    @Benchmark
    public KeyStore.Entry getPKCS12KeyEntryKona(PKCS12KeyStoreHolderKona holder)
            throws Exception {
        return holder.keyStore.getEntry("ee", PROTECTION);
    }

    @Benchmark
    public KeyStore.Entry getJKSKeyEntryKona(JKSKeyStoreHolderKona holder)
            throws Exception {
        return holder.keyStore.getEntry("ee", PROTECTION);
    }

    @Benchmark
    public KeyStore.Entry getPKCS12KeyEntryJDK(PKCS12KeyStoreHolderJDK holder)
            throws Exception {
        return holder.keyStore.getEntry("ee", PROTECTION);
    }

    @Benchmark
    public KeyStore.Entry getJKSKeyEntryJDK(JKSKeyStoreHolderJDK holder)
            throws Exception {
        return holder.keyStore.getEntry("ee", PROTECTION);
    }
    ...
    private static KeyStore createKeyStore(String type)
            throws Exception {
        return createKeyStore(type, null);
    }
