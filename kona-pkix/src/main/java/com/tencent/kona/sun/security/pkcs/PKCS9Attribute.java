...
public class PKCS9Attribute implements DerEncoder {
    ...
    private static class AttributeInfo<T> {
        ...
        AttributeInfo(boolean singleValued, Class<?> valueClass,
    ...
    static {
        ...
        add(CONTENT_TYPE_OID, true, ObjectIdentifier.class,
            DerValue::getOID,
        ...
        add(COUNTERSIGNATURE_OID, false, SignerInfo.class,
        ...
        add(EXTENSION_REQUEST_OID, true, CertificateExtensions.class,
            a -> new CertificateExtensions(new DerInputStream(a.toByteArray())),
            (t, v) -> v.encode(t, true),
            DerValue.tag_Sequence);

        add(SIGNING_CERTIFICATE_OID, true, SigningCertificateInfo.class,
    ...
    public PKCS9Attribute(ObjectIdentifier oid, Object value)
        ...
        Class<?> clazz = info == null
            ? byte[].class
            : info.singleValued ? info.valueClass : Array.newInstance(info.valueClass, 0).getClass();
