    ...
    static {
        try {
            ...
            VALUE_CLASSES[14] =        // ExtensionRequest
                    Class.forName("com.tencent.kona.sun.security.x509.CertificateExtensions");
            ...
            case 16:    // SigningCertificate
                {
                    ...
                    temp2.write(infoBytes, 0, infoBytes.length);
                    temp.write(DerValue.tag_Set, temp2.toByteArray());
                }
                break;
