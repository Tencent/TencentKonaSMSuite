...
public final class OCSPResponse {
    ...
    private static final ObjectIdentifier OCSP_BASIC_RESPONSE_OID =
            Oid.of(KnownOIDs.OCSPBasicResponse);
    ...
    private static int initializeClockSkew() {
        ...
        Integer tmp = java.security.AccessController.doPrivileged(
                new GetIntegerAction("com.tencent.kona.pkix.ocsp.clockSkew"));
        if (tmp == null || tmp < 0) {
    ...
    private boolean verifySignature(X509Certificate cert)
        ...
        try {
            Signature respSignature = CryptoInsts.getSignature(sigAlgId.getName());
