...
import com.tencent.kona.sun.security.util.CollectionUtil;
...
class RevocationChecker extends PKIXRevocationChecker {
    ...
    RevocationChecker(TrustAnchor anchor, PKIX.ValidatorParams params)
    ...
    void init(TrustAnchor anchor, PKIX.ValidatorParams params)
            throws CertPathValidatorException
    {
        ...
        try {
            this.certStores.add(PKIXInsts.getCertStore("Collection",
                ...
                new PrivilegedAction<RevocationProperties>() {
                    public RevocationProperties run() {
                        ...
                        String onlyEE = Security.getProperty(
                                "com.tencent.kona.pkix.onlyCheckRevocationOfEECert");
                        ...
                        rp.crlDPEnabled
                                = Boolean.getBoolean("com.tencent.kona.pkix.enableCRLDP");
                        rp.ocspNonce
...
//        CertPathHelper.setDateAndTime(sel, params.date(), MAX_CLOCK_SKEW);
                    ...
                    if (nonce == null) {
                        try {
                            ...
                            if (ocspExtensions.size() > 0) {
                                ...
                                tmpExtensions = CollectionUtil.list(nonceExt);
                            }
            ...
            throws CertPathValidatorException
    {
        ...
        try {
            builder = PKIXInsts.getCertPathBuilder("PKIX");
