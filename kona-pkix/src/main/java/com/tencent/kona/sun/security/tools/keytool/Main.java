...
import com.tencent.kona.sun.security.provider.certpath.CertPathConstraintsParameters;
import com.tencent.kona.sun.security.util.ConstraintsParameters;
import com.tencent.kona.sun.security.util.ECKeySizeParameterSpec;
...
import com.tencent.kona.sun.security.pkcs10.PKCS10Attribute;
import com.tencent.kona.sun.security.provider.X509Factory;
import com.tencent.kona.sun.security.provider.certpath.ssl.SSLServerCertStore;
import com.tencent.kona.sun.security.util.KnownOIDs;
import com.tencent.kona.sun.security.util.Password;
...
import com.tencent.kona.sun.security.util.Pem;
import com.tencent.kona.sun.security.validator.Validator;
import com.tencent.kona.sun.security.x509.*;

import static java.security.KeyStore.*;
import static com.tencent.kona.sun.security.tools.keytool.Main.Command.*;
import static com.tencent.kona.sun.security.tools.keytool.Main.Option.*;
 ...
 * @see com.tencent.kona.sun.security.provider.KeyProtector
 * @see com.tencent.kona.sun.security.provider.JavaKeyStore
 *
 * @since 1.2
 */
...
//    private Set<Pair <String, String>> providerClasses = null;
    ...
    private static final java.util.ResourceBundle rb =
        java.util.ResourceBundle.getBundle(
            "com.tencent.kona.sun.security.tools.keytool.Resources");
...
//        }
        ...
        if (ksfile != null && ksStream != null && providerName == null &&
            ...
            if (storetype == null) {
                ...
                keyStore = KeyStoreUtil.getKeyStore(ksfile, storePass);
                storetype = keyStore.getType();
            } else {
                keyStore = PKIXInsts.getKeyStore(storetype);
        ...
        if (isKeyStoreRelated(command)
            ...
            if (f.exists()) {
                ...
                try {
                    keyStore = KeyStoreUtil.getKeyStore(f, pass);
...
//                    }
                    String realSourceStoreType = KeyStoreUtil.keyStoreType(
        ...
        throws Exception
    {
        ...
        if (keyAlgName.toUpperCase(Locale.ENGLISH).startsWith("PBE")) {
            ...
            KeyGenerator keygen = CryptoInsts.getKeyGenerator(keyAlgName);
            if (keysize == -1) {
    ...
    KeyStore loadSourceKeyStore() throws Exception {
        ...
        try {
            ...
            if (srcksfile != null && srcProviderName == null && srcstoretype == null) {
                store = KeyStoreUtil.getKeyStore(srcksfile, srcstorePass);
                ...
                if (srcProviderName == null) {
                    store = PKIXInsts.getKeyStore(srcstoretype);
                } else {
...
//                byte[] bytes = in.readAllBytes();
                ...
                return PKIXInsts.getCertificateFactory("X509").generateCRLs(
...
//            return s.getCRLs(new X509CRLSelector());
            throw new UnsupportedOperationException("Not support LDAP");
        }
    }
    ...
    private Collection<? extends Certificate> generateCertificates(InputStream in)
        ...
        try {
            return PKIXInsts.getCertificateFactory("X.509")
        ...
        while (i1.hasNext() || i2.hasNext()) {
            ...
            if (ext.getClass() == Extension.class) {
                ...
                if (v.length == 0) {
                    ...
                    new HexDumpEncoder().encodeBuffer(ext.getExtensionValue(), out);
                    out.println();
                }
            }
            out.println();
        ...
        throws Exception
    {
        ...
        MessageDigest md = CryptoInsts.getMessageDigest(mdAlg);
