...
public class OIDMap {
    ...
    static {
        ...
        addInternal(SUB_KEY_IDENTIFIER, PKIXExtensions.SubjectKey_Id,
                    "com.tencent.kona.sun.security.x509.SubjectKeyIdentifierExtension");
        addInternal(KEY_USAGE, PKIXExtensions.KeyUsage_Id,
                    "com.tencent.kona.sun.security.x509.KeyUsageExtension");
        addInternal(PRIVATE_KEY_USAGE, PKIXExtensions.PrivateKeyUsage_Id,
                    "com.tencent.kona.sun.security.x509.PrivateKeyUsageExtension");
        addInternal(SUB_ALT_NAME, PKIXExtensions.SubjectAlternativeName_Id,
                    "com.tencent.kona.sun.security.x509.SubjectAlternativeNameExtension");
        addInternal(ISSUER_ALT_NAME, PKIXExtensions.IssuerAlternativeName_Id,
                    "com.tencent.kona.sun.security.x509.IssuerAlternativeNameExtension");
        addInternal(BASIC_CONSTRAINTS, PKIXExtensions.BasicConstraints_Id,
                    "com.tencent.kona.sun.security.x509.BasicConstraintsExtension");
        addInternal(CRL_NUMBER, PKIXExtensions.CRLNumber_Id,
                    "com.tencent.kona.sun.security.x509.CRLNumberExtension");
        addInternal(CRL_REASON, PKIXExtensions.ReasonCode_Id,
                    "com.tencent.kona.sun.security.x509.CRLReasonCodeExtension");
        ...
        addInternal(POLICY_MAPPINGS, PKIXExtensions.PolicyMappings_Id,
                    "com.tencent.kona.sun.security.x509.PolicyMappingsExtension");
        addInternal(AUTH_KEY_IDENTIFIER, PKIXExtensions.AuthorityKey_Id,
                    "com.tencent.kona.sun.security.x509.AuthorityKeyIdentifierExtension");
        addInternal(POLICY_CONSTRAINTS, PKIXExtensions.PolicyConstraints_Id,
                    "com.tencent.kona.sun.security.x509.PolicyConstraintsExtension");
        addInternal(NETSCAPE_CERT, Oid.of(new int[] {2,16,840,1,113730,1,1}),
                    "com.tencent.kona.sun.security.x509.NetscapeCertTypeExtension");
        ...
        addInternal(INHIBIT_ANY_POLICY, PKIXExtensions.InhibitAnyPolicy_Id,
                    "com.tencent.kona.sun.security.x509.InhibitAnyPolicyExtension");
        ...
        addInternal(CERT_ISSUER, PKIXExtensions.CertificateIssuer_Id,
                    "com.tencent.kona.sun.security.x509.CertificateIssuerExtension");
        addInternal(SUBJECT_INFO_ACCESS, PKIXExtensions.SubjectInfoAccess_Id,
                    "com.tencent.kona.sun.security.x509.SubjectInfoAccessExtension");
        addInternal(AUTH_INFO_ACCESS, PKIXExtensions.AuthInfoAccess_Id,
                    "com.tencent.kona.sun.security.x509.AuthorityInfoAccessExtension");
        addInternal(ISSUING_DIST_POINT,
                    PKIXExtensions.IssuingDistributionPoint_Id,
                    "com.tencent.kona.sun.security.x509.IssuingDistributionPointExtension");
        addInternal(DELTA_CRL_INDICATOR, PKIXExtensions.DeltaCRLIndicator_Id,
                    "com.tencent.kona.sun.security.x509.DeltaCRLIndicatorExtension");
        addInternal(FRESHEST_CRL, PKIXExtensions.FreshestCRL_Id,
                    "com.tencent.kona.sun.security.x509.FreshestCRLExtension");
        addInternal(OCSPNOCHECK, PKIXExtensions.OCSPNoCheck_Id,
                    "com.tencent.kona.sun.security.x509.OCSPNoCheckExtension");
    }
    ...
    public static void addAttribute(String name, String oid, Class<?> clazz)
        ...
        ObjectIdentifier objId = Oid.of(oid);
