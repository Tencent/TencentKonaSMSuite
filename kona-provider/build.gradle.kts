...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("Tencent Kona Provider")
                description.set("A Java security provider for supporting ShangMi features")
                url.set("https://github.com/Tencent/TencentKonaSMSuite/tree/master/kona-provider")
                licenses {
                    license {
