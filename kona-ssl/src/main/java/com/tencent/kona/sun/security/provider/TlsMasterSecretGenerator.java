        ...
        try {
            ...
            if (protocolVersion >= 0x0301) {
                ...
                master = ((protocolVersion >= 0x0303) ?
                        ...
                        TlsPrfGenerator.doTLS10PRF(premaster, label, seed, 48));
            } else {
                master = new byte[48];
                MessageDigest md5 = CryptoInsts.getMessageDigest("MD5");
                MessageDigest sha = CryptoInsts.getMessageDigest("SHA");
