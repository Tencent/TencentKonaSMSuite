...
final class CertificateVerify {
    ...
    static final class S30CertificateVerifyMessage extends HandshakeMessage {
        ...
        private static Signature getSignature(String algorithm,
            ...
            switch (algorithm) {
                case "RSA":
                    signer = CryptoInsts.getSignature(JsseJce.SIGNATURE_RAWRSA);
                    break;
                case "DSA":
                    signer = CryptoInsts.getSignature(JsseJce.SIGNATURE_RAWDSA);
                    break;
                case "EC":
                    signer = CryptoInsts.getSignature(JsseJce.SIGNATURE_RAWECDSA);
                    break;
                default:
