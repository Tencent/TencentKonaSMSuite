...
enum CipherSuite {
    ...
    // TLS 1.3 SM cipher suite
    TLS_SM4_GCM_SM3(
            0x00C6, true, "TLS_SM4_GCM_SM3",
            ProtocolVersion.PROTOCOLS_OF_13, SSLCipher.B_SM4_GCM_IV, H_SM3),
    ...
    TLS_AES_256_GCM_SHA384(
            ...
            ProtocolVersion.PROTOCOLS_OF_13, SSLCipher.B_AES_256_GCM_IV, H_SHA384),
    TLS_AES_128_GCM_SHA256(
            0x1301, true, "TLS_AES_128_GCM_SHA256",
            ProtocolVersion.PROTOCOLS_OF_13, SSLCipher.B_AES_128_GCM_IV, H_SHA256),
    TLS_CHACHA20_POLY1305_SHA256(
            0x1303, true, "TLS_CHACHA20_POLY1305_SHA256",
            ProtocolVersion.PROTOCOLS_OF_13, SSLCipher.B_CC20_P1305, H_SHA256),
    ...
    TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384(
            ...
            K_ECDHE_ECDSA, SSLCipher.B_AES_256_GCM, M_NULL, H_SHA384),
    TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256(
            0xC02B, true, "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDHE_ECDSA, SSLCipher.B_AES_128_GCM, M_NULL, H_SHA256),
    ...
    TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256(
            ...
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDHE_ECDSA, SSLCipher.B_CC20_P1305, M_NULL, H_SHA256),
    ...
    TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384(
            ...
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_ECDSA, SSLCipher.B_AES_256_GCM, M_NULL, H_SHA384),
    TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384(
            0xC032, true, "TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_RSA, SSLCipher.B_AES_256_GCM, M_NULL, H_SHA384),

    // AES_128(GCM)
    TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256(
            0xC02D, true, "TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_ECDSA, SSLCipher.B_AES_128_GCM, M_NULL, H_SHA256),
    TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256(
            0xC031, true, "TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_RSA, SSLCipher.B_AES_128_GCM, M_NULL, H_SHA256),

    // AES_256(CBC)
    TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384(
            0xC026, true, "TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_ECDSA, SSLCipher.B_AES_256, M_SHA384, H_SHA384),
    TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384(
            0xC02A, true, "TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_RSA, SSLCipher.B_AES_256, M_SHA384, H_SHA384),

    // AES_128(CBC)
    TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256(
            0xC025, true, "TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_ECDSA, SSLCipher.B_AES_128, M_SHA256, H_SHA256),
    TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256(
            0xC029, true, "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256", "",
            ProtocolVersion.PROTOCOLS_OF_12,
            K_ECDH_RSA, SSLCipher.B_AES_128, M_SHA256, H_SHA256),
    ...
    int calculatePacketSize(int fragmentSize,
        ...
        if (bulkCipher != null && bulkCipher != SSLCipher.B_NULL) {
