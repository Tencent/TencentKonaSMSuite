...
final class DHKeyExchange {
    ...
    static final class DHECredentials implements NamedGroupCredentials {
        ...
        static DHECredentials valueOf(NamedGroup ng,
            ...
            KeyFactory kf = CryptoInsts.getKeyFactory("DiffieHellman");
    ...
    static final class DHEPossession implements NamedGroupPossession {
        ...
        DHEPossession(NamedGroup namedGroup, SecureRandom random) {
            try {
                KeyPairGenerator kpg =
                        CryptoInsts.getKeyPairGenerator("DiffieHellman");
        ...
        private static DHPublicKeySpec getDHPublicKeySpec(PublicKey key) {
            ...
            try {
                KeyFactory factory = CryptoInsts.getKeyFactory("DiffieHellman");
    ...
    private static final class
        ...
        static {
            String property = GetPropertyAction.privilegedGetProperty(
                    "com.tencent.kona.ssl.ephemeralDHKeySize");
            if (property == null || property.isEmpty()) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException(
                        "Invalid system property com.tencent.kona.ssl.ephemeralDHKeySize");
                }
            }
        }
        ...
        public SSLPossession createPossession(HandshakeContext context) {
             ...
             * mode (system property "com.tencent.kona.ssl.ephemeralDHKeySize" is defined
             * as "legacy").
             *
             ...
             * "com.tencent.kona.ssl.ephemeralDHKeySize" to a valid positive integer between
