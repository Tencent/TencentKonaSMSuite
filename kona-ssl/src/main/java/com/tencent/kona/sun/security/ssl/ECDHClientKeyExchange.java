 ...
 *
 * This file is used by both the ECDH/ECDHE code since much of the
 * code is the same between the EC named groups (i.e.
 * secp*r1), even though the APIs are very different (i.e.
 * ECPublicKey, KeyExchange.getInstance("EC"), etc.).
 */
        ...
        public byte[] produce(ConnectionContext context,
            ...
            if (algorithm.equals("EC")) {
                ...
                throw chc.conContext.fatal(Alert.ILLEGAL_PARAMETER,
                    "Not EC server certificate for " +
                            "ECDH client key exchange");
            }

            if (namedGroup == null) {
                throw chc.conContext.fatal(Alert.ILLEGAL_PARAMETER,
                    "Unsupported EC server cert for " +
                        "ECDH client key exchange");
            }
