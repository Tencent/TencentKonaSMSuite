...
final class ExtendedMasterSecretExtension {
    ...
    private static final
        ...
        public byte[] produce(ConnectionContext context,
            ...
            if (!chc.sslConfig.isAvailable(SSLExtension.CH_EXTENDED_MASTER_SECRET) ||
            ...
            if (chc.handshakeSession == null ||
                ...
                chc.handshakeExtensions.put(SSLExtension.CH_EXTENDED_MASTER_SECRET,
    ...
    private static final
        ...
        public void consume(ConnectionContext context,
            ...
            // Is it a supported and enabled extension?
            if (!shc.sslConfig.isAvailable(SSLExtension.CH_EXTENDED_MASTER_SECRET) ||
                    !SSLConfiguration.useExtendedMasterSecret ||
                    !shc.negotiatedProtocol.useTLS10PlusSpec()) {
                if (SSLLogger.isOn && SSLLogger.isOn("ssl,handshake")) {
                    SSLLogger.fine("Ignore unavailable extension: " +
                            SSLExtension.CH_EXTENDED_MASTER_SECRET.name);
                }
            ...
            shc.handshakeExtensions.put(
                SSLExtension.CH_EXTENDED_MASTER_SECRET, ExtendedMasterSecretSpec.NOMINAL);
    ...
    private static final
        ...
        public byte[] produce(ConnectionContext context,
            ...
            if (shc.handshakeSession.useExtendedMasterSecret) {
                byte[] extData = new byte[0];
                shc.handshakeExtensions.put(SSLExtension.SH_EXTENDED_MASTER_SECRET,
                        ExtendedMasterSecretSpec.NOMINAL);
    ...
    private static final
        ...
        public void consume(ConnectionContext context,
            ...
            ExtendedMasterSecretSpec requstedSpec = (ExtendedMasterSecretSpec)
                    chc.handshakeExtensions.get(SSLExtension.CH_EXTENDED_MASTER_SECRET);
            ...
            chc.handshakeExtensions.put(
                SSLExtension.SH_EXTENDED_MASTER_SECRET, ExtendedMasterSecretSpec.NOMINAL);
