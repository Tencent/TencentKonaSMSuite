...
final class MaxFragExtension {
        ...
        public byte[] produce(ConnectionContext context,
            ...
            if (mfl != null) {
                ...
                chc.handshakeExtensions.put(
                        SSLExtension.CH_MAX_FRAGMENT_LENGTH, new MaxFragLenSpec(mfl.id));
    ...
    private static final
        ...
        public byte[] produce(ConnectionContext context,
            ...
            MaxFragLenSpec spec = (MaxFragLenSpec)
                    shc.handshakeExtensions.get(SSLExtension.CH_MAX_FRAGMENT_LENGTH);
            if (spec == null) {
                if (SSLLogger.isOn && SSLLogger.isOn("ssl,handshake")) {
                    SSLLogger.finest(
                        "Ignore unavailable max_fragment_length extension");
    ...
    private static final
        ...
        public void consume(ConnectionContext context,
            ...
            MaxFragLenSpec requestedSpec = (MaxFragLenSpec)
                    chc.handshakeExtensions.get(SSLExtension.CH_MAX_FRAGMENT_LENGTH);
    ...
    private static final class SHMaxFragmentLengthUpdate
        ...
        public void consume(ConnectionContext context,
            ...
            MaxFragLenSpec spec = (MaxFragLenSpec)
                    chc.handshakeExtensions.get(SSLExtension.SH_MAX_FRAGMENT_LENGTH);
            if (spec == null) {
    ...
    private static final
        ...
        public void consume(ConnectionContext context,
            ...
            MaxFragLenSpec spec = (MaxFragLenSpec)
                    chc.handshakeExtensions.get(SSLExtension.EE_MAX_FRAGMENT_LENGTH);
            if (spec == null) {
                // Ignore, no "max_fragment_length" extension response.
                return;
            }
