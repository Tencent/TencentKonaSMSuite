...
enum ProtocolVersion {
    ...
    // TLS ProtocolVersion array for TLCP
    static final ProtocolVersion[] PROTOCOLS_TO_TLCP = new ProtocolVersion[] {
            TLCP11, TLS13, TLS12
    };

    // TLS ProtocolVersion array for TLCP
    static final ProtocolVersion[] PROTOCOLS_OF_TLCP = new ProtocolVersion[] {
            TLCP11
    };
