...
final class RSAKeyExchange {
    ...
    static final
        ...
        byte[] getEncoded(PublicKey publicKey,
            ...
            Cipher cipher = CryptoInsts.getCipher(JsseJce.CIPHER_RSA_PKCS1);
        ...
        static RSAPremasterSecret createPremasterSecret(
            ...
            KeyGenerator kg = CryptoInsts.getKeyGenerator(algorithm);
        ...
        static RSAPremasterSecret decode(ServerHandshakeContext shc,
            ...
            if (needFailover) {
                ...
                cipher = CryptoInsts.getCipher(JsseJce.CIPHER_RSA_PKCS1);
