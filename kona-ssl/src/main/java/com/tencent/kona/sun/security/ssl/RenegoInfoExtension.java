        ...
        public byte[] produce(ConnectionContext context,
            ...
            if (!chc.conContext.isNegotiated) {
                ...
                chc.handshakeExtensions.put(
                        SSLExtension.CH_RENEGOTIATION_INFO, RenegotiationInfoSpec.NOMINAL);
            ...
            if (!shc.sslConfig.isAvailable(SSLExtension.CH_RENEGOTIATION_INFO)) {
                if (SSLLogger.isOn && SSLLogger.isOn("ssl,handshake")) {
                    SSLLogger.fine("Ignore unavailable extension: " +
                            SSLExtension.CH_RENEGOTIATION_INFO.name);
                }
    ...
    private static final
        ...
        public byte[] produce(ConnectionContext context,
            ...
            RenegotiationInfoSpec requestedSpec = (RenegotiationInfoSpec)
                    shc.handshakeExtensions.get(SSLExtension.CH_RENEGOTIATION_INFO);
            ...
            if (!shc.conContext.isNegotiated) {
                ...
                shc.handshakeExtensions.put(
                        SSLExtension.SH_RENEGOTIATION_INFO, RenegotiationInfoSpec.NOMINAL);
