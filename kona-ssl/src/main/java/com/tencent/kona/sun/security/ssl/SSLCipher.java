...
import static com.tencent.kona.sun.security.ssl.CipherType.*;
import static com.tencent.kona.sun.security.ssl.JsseJce.*;
...
enum SSLCipher {
    ...
    private static final Map<String, Long> cipherLimits = new HashMap<>();
    ...
    private static boolean isTransformationAvailable(String transformation) {
        ...
        try {
            CryptoInsts.getCipher(transformation);
            return true;
    ...
    static void addMac(Authenticator.MAC signer,
    ...
    private static void checkStreamMac(Authenticator.MAC signer, ByteBuffer bb,
    ...
    // for CBC cipher
    static void checkCBCMac(Authenticator.MAC signer, ByteBuffer bb,
    ...
    private static boolean checkMacTags(byte contentType, ByteBuffer bb,
                                        Authenticator.MAC signer, byte[] sequence, boolean isSimulated) {
        int tagLen = signer.macAlg().size;
    ...
    private static int calculateRemainingLen(
            Authenticator.MAC signer, int fullLen, int usedLen) {
    ...
    static int addPadding(ByteBuffer bb, int blockSize) {
    ...
    static int removePadding(ByteBuffer bb,
