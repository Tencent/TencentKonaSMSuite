...
public abstract class SSLContextImpl extends SSLContextSpi {
    ...
    private final boolean clientEnableStapling = Utilities.getBooleanProperty(
            "com.tencent.kona.ssl.client.enableStatusRequestExtension", true);
    private final boolean serverEnableStapling = Utilities.getBooleanProperty(
            "com.tencent.kona.ssl.server.enableStatusRequestExtension", false);
    private static final Collection<CipherSuite> clientCustomizedCipherSuites =
            getCustomizedCipherSuites("com.tencent.kona.ssl.client.cipherSuites");
    private static final Collection<CipherSuite> serverCustomizedCipherSuites =
            getCustomizedCipherSuites("com.tencent.kona.ssl.server.cipherSuites");
    ...
    protected void engineInit(KeyManager[] km, TrustManager[] tm,
        ...
        if (tm == null) {
            try {
                TrustManagerFactory tmf = SSLInsts.getTrustManagerFactory(
    ...
    static class CustomizedSSLProtocols {
        private static final String JDK_TLS_CLIENT_PROTOCOLS =
                "com.tencent.kona.ssl.client.protocols";
        private static final String JDK_TLS_SERVER_PROTOCOLS =
                "com.tencent.kona.ssl.server.protocols";
    ...
    private static final class DefaultManagersHolder {
        ...
        private static KeyManager[] getKeyManagers() throws Exception {
            ...
            AccessController.doPrivileged(
                ...
                public Object run() {
                    ...
                    props.put("keyStoreType", System.getProperty(
                                "com.tencent.kona.ssl.keyStoreType",
                                KeyStore.getDefaultType()));
                    props.put("keyStoreProvider", System.getProperty(
                                "com.tencent.kona.ssl.keyStoreProvider", ""));
                    props.put("keyStorePasswd", System.getProperty(
                                "com.tencent.kona.ssl.keyStorePassword", ""));
                    return null;
                }
            });
            ...
            try {
                ...
                if ((defaultKeyStoreType.length()) != 0) {
                    ...
                    if (defaultKeyStoreProvider.isEmpty()) {
                        ks = PKIXInsts.getKeyStore(defaultKeyStoreType);
                    } else {
            ...
            KeyManagerFactory kmf = SSLInsts.getKeyManagerFactory(
                KeyManagerFactory.getDefaultAlgorithm());
