...
enum SSLHandshake implements SSLConsumer, HandshakeProducer {
    ...
    CERTIFICATE                 ((byte)0x0B, "certificate",
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificate.tlcpHandshakeConsumer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
            ...
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificate.tlcpHandshakeProducer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
    ...
    CERTIFICATE_REQUEST         ((byte)0x0D, "certificate_request",
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificateRequest.tlcpHandshakeConsumer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
            ...
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificateRequest.tlcpHandshakeProducer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
    ...
    CERTIFICATE_VERIFY          ((byte)0x0F, "certificate_verify",
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificateVerify.tlcpHandshakeConsumer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
            ...
            new Map.Entry[] {
                    new SimpleImmutableEntry<>(
                            TLCPCertificateVerify.tlcpHandshakeProducer,
                            ProtocolVersion.PROTOCOLS_OF_TLCP
                    ),
                    new SimpleImmutableEntry<>(
