...
final class SSLKeyExchange implements SSLKeyAgreementGenerator,
    ...
    SSLKeyExchange(List<SSLAuthentication> authentication,
        ...
        if (authentication != null) {
            this.authentication = Collections.unmodifiableList(authentication);
        } else {
    ...
    SSLPossession[] createPossessions(HandshakeContext context) {
        ...
        if (keyAgreement == T12KeyAgreement.RSA_EXPORT) {
            ...
            if (kaPossession == null) {
                // special cases
                if (keyAgreement == TLCPKeyAgreement.SM2
                        || keyAgreement == T12KeyAgreement.RSA
    ...
    private static class TLCPKeyExSM2 {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(TLCPAuthentication.SM2), TLCPKeyAgreement.SM2);
    }
    ...
    private static class SSLKeyExRSA {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA), T12KeyAgreement.RSA);
    }

    private static class SSLKeyExRSAExport {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA), T12KeyAgreement.RSA_EXPORT);
    }

    private static class SSLKeyExDHEDSS {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.DSA), T12KeyAgreement.DHE);
    }

    private static class SSLKeyExDHEDSSExport {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.DSA), T12KeyAgreement.DHE_EXPORT);
    }

    private static class SSLKeyExDHERSA {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA), T12KeyAgreement.DHE);
    }

    private static class SSLKeyExDHERSAOrPSS {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA_OR_PSS), T12KeyAgreement.DHE);
    }

    private static class SSLKeyExDHERSAExport {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA), T12KeyAgreement.DHE_EXPORT);
    }
    ...
    private static class SSLKeyExECDHECDSA {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.EC), T12KeyAgreement.ECDH);
    }
    ...
    private static class SSLKeyExECDHEECDSA {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.EC, X509Authentication.EDDSA),
                T12KeyAgreement.ECDHE);
    }

    private static class SSLKeyExECDHESM2 {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.EC),
                T12KeyAgreement.ECDHE);
    }

    private static class SSLKeyExECDHERSA {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA), T12KeyAgreement.ECDHE);
    }

    private static class SSLKeyExECDHERSAOrPSS {
        private static final SSLKeyExchange KE = new SSLKeyExchange(
                Arrays.asList(X509Authentication.RSA_OR_PSS), T12KeyAgreement.ECDHE);
    }
