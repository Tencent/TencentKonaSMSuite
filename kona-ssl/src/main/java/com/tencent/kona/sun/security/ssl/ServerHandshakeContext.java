...
class ServerHandshakeContext extends HandshakeContext {
    ...
    // "com.tencent.kona.ssl.rejectClientInitiatedRenegotiation" to true, applications in
    ...
    static final boolean rejectClientInitiatedRenego =
            Utilities.getBooleanProperty(
                "com.tencent.kona.ssl.rejectClientInitiatedRenegotiation", false);
    ...
    ServerHandshakeContext(SSLContextImpl sslContext,
        ...
        long respTimeOut = AccessController.doPrivileged(
                    new GetLongAction("com.tencent.kona.ssl.stapling.responseTimeout",
