...
final class TLCPAuthentication implements SSLAuthentication {
    ...
    static final class TLCPPossession implements SSLPossession {
        ...
        ECParameterSpec getECParameterSpec(PrivateKey popPrivateKey,
    ...
    static final class TLCPCredentials implements SSLCredentials {
        ...
        TLCPCredentials(PublicKey popSignPublicKey,
                        X509Certificate[] popSignCerts,
    ...
    private static TLCPPossession createPossession(
        ...
        if (encPossEntry == null
                && PKIXUtils.isEncCert(signPossEntry.popCert)) {
