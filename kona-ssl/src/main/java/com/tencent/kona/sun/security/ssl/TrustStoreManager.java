...
import com.tencent.kona.sun.security.action.OpenFileInputStreamAction;
import com.tencent.kona.sun.security.util.FilePaths;
import com.tencent.kona.sun.security.validator.TrustStoreUtil;
             ...
             return AccessController.doPrivileged(
                ...
                public TrustStoreDescriptor run() {
                    ...
                    String storePropName = System.getProperty(
                            "com.tencent.kona.ssl.trustStore", jsseDefaultStore);
                    String storePropType = System.getProperty(
                            "com.tencent.kona.ssl.trustStoreType",
                            KeyStore.getDefaultType());
                    String storePropProvider = System.getProperty(
                            "com.tencent.kona.ssl.trustStoreProvider", "");
                    String storePropPassword = System.getProperty(
                            "com.tencent.kona.ssl.trustStorePassword", "");
    ...
    private static final class TrustAnchorManager {
        ...
        private static KeyStore loadKeyStore(
            ...
            if (descriptor.storeProvider.isEmpty()) {
                ks = PKIXInsts.getKeyStore(descriptor.storeType);
            } else {
