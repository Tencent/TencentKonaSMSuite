...
public abstract class AbstractPeer implements Peer {
    ...
    public static abstract class Builder implements Peer.Builder {
        ...
        private ContextProtocol contextProtocol = ContextProtocol.TLS;
        ...
        private SignatureScheme[] signatureSchemes;

        private boolean useSessTicket;
        ...
        public ContextProtocol getContextProtocol() {
            return contextProtocol;
        }

        public Builder setContextProtocol(ContextProtocol contextProtocol) {
        ...
        public Builder setSignatureSchemes(SignatureScheme... signatureSchemes) {
            this.signatureSchemes = signatureSchemes;
            return this;
        }

        public boolean isUseSessTicket() {
            return useSessTicket;
        }

        public Builder setUseSessTicket(boolean useSessTicket) {
            this.useSessTicket = useSessTicket;
            return this;
        }
