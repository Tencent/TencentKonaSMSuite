...
public class SSLSocketTest {
    ...
    public enum Cert {
        ...
        CA_CERT(
                TestUtils.certStr("tlcp", "tlcp-intca.crt"),
                TestUtils.keyStr("tlcp", "tlcp-intca.key")),
        SERVER_SIGN_CERT(
                TestUtils.certStr("tlcp", "tlcp-server-sign.crt"),
                TestUtils.keyStr("tlcp", "tlcp-server-sign.key")),
        SERVER_ENC_CERT(TestUtils.certStr("tlcp", "tlcp-server-enc.crt"),
                TestUtils.keyStr("tlcp", "tlcp-server-enc.key")),
        CLIENT_SIGN_CERT(
                TestUtils.certStr("tlcp", "tlcp-client-sign.crt"),
                TestUtils.keyStr("tlcp", "tlcp-client-sign.key")),
        CLIENT_ENC_CERT(
                TestUtils.certStr("tlcp", "tlcp-client-enc.crt"),
                TestUtils.keyStr("tlcp", "tlcp-client-enc.key"));
